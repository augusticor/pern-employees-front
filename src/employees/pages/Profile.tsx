  ...
  return (
    <div className='bg-neutral-100 flex justify-center p-10'>
      <main className='flex flex-col gap-y-12 bg-amber-50 rounded-lg shadow-md p-10 overflow-y-scroll'>
        ...
        <form className='grid grid-cols-4 gap-y-8 gap-x-10' onSubmit={handleEditInfo}>
          ...
          <button className='bg-sky-800 text-neutral-100 text-lg rounded-lg py-2 mt-5 hover:bg-sky-900'>
            Edit info
          </button>
        </form>
        ...
        <strong className='text-sky-500'>Update Password</strong>
